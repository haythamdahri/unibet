...
public class DataPopulate {
    ...
    public void createRealPsgData() {
        ...
        final Event marocVsCroatie = eventRepository.save(new Event().setName("Maroc vs Croatie").setStartDate(new Date()));
        ...
        final Market marketExpectations = marketRepository.save(new Market().setName("Expectations").setEvent(marocVsCroatie));
        ...
        selectionRepository.save(new Selection()
                .setName("Maroc gagne")
                .setState(SelectionState.OPENED)
                .setCurrentOdd(new BigDecimal("4.3"))
                .setMarket(marketExpectations));
        selectionRepository.save(new Selection()
                .setName("Maroc gagne")
